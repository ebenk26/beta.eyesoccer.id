    ...
    <div class="center-desktop m-0">
        <div class="m-0 mt-20">
            <div class="container tube-l">
                <div>
                    <video controlsList="nodownload" width="735px" height="415px" controls style="border-bottom: 1px solid gainsboro;" poster="<?= imgUrl(); ?>systems/eyetube_storage/<?= $eyetube_headline->thumb; ?>">
